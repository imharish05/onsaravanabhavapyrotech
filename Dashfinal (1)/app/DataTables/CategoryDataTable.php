...
class CategoryDataTable extends DataTable
{
        ...
        return (new EloquentDataTable($query))
            ...
            ->addColumn('category_image', function ($row) {
                ...
                if ($row->category_image) {
                    $url = asset($row->category_image); // Safe even if it's relative
            ...
            ->rawColumns(['category_image']);
    }

    public function query(Category $model): QueryBuilder
    {
        return $model->newQuery()->select('id', 'category_name','category_image');
    }
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('category_image')->title('Category Image'),
        ];
    }
